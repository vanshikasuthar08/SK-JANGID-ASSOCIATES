...
import { Building2, Award, Users, Briefcase, Leaf, ArrowRight, CheckCircle } from 'lucide-react';
...
export function HomePage({ onNavigate }: HomePageProps) {
  const stats = [
    ...
    { icon: Users, value: '75+', label: 'Happy Clients' },
    { icon: Award, value: '35+', label: 'Awards Won' },
    { icon: Briefcase, value: '20+', label: 'Years of Excellence' },
  ];
  ...
  return (
    <div className="pt-20">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        >
          <ImageWithFallback
            src="https://images.unsplash.com/photo-1654371404345-845d8aa147f3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBhcmNoaXRlY3R1cmUlMjBidWlsZGluZ3xlbnwxfHx8fDE3NjA3ODMyNTV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            SK Jangid & Associates brings your architectural dreams to life with innovative design, 
            sustainable practices, and unparalleled expertise
          </motion.p>
      ...
      <section className="py-20 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl mb-4">Excellence in Every Aspect</h2>
